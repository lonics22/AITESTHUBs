...
export default {
  ...
  aiImport: {
    ...
    stepAnalysis: 'AI Analysis Results',
    ...
    analysisLoading: 'AI is generating test cases...',
    analysisStats: '{normal} normal, {error} error cases, {endpoints} endpoints',
    body: 'Body',
    errorAnalysisFailed: 'AI analysis failed',
    errorSaveFailed: 'Save failed',
    phaseGenerating: 'Generating test cases...',
    phaseReviewing: 'Reviewing quality...',
    phaseRetrying: 'Retrying with feedback...',
    phaseComplete: 'Complete',
    sseTimeout: 'Connection timeout, switching to backup mode',
    sseConnectionFailed: 'Real-time connection failed, switching to backup mode'
  }
}

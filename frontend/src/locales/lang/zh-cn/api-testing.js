...
export default {
  ...
  aiImport: {
    ...
    aiAnalyze: 'AI 分析',
    confirmSave: '确认保存',
    analysisLoading: 'AI 正在分析生成测试用例...',
    analysisStats: '共 {normal} 个正常用例，{error} 个错误用例，{endpoints} 个端点',
    body: '请求体',
    errorAnalysisFailed: 'AI 分析失败',
    errorSaveFailed: '保存失败',
    phaseGenerating: '正在生成测试用例...',
    phaseReviewing: '正在评审质量...',
    phaseRetrying: '正在根据反馈重试...',
    phaseComplete: '已完成',
    sseTimeout: '连接超时，切换至备用模式',
    sseConnectionFailed: '实时连接失败，切换至备用模式'
  }
}
